		    	...
		    	<div class="row">
					<div class="s-push1 s-column10 m-push2 m-column8">
					    ...
					    <section>
						    ...
						    <div class='clearfix'>
								<div class='f-left rounded1 third-color mr1 mb1' style='height: 50px; width: 50px;'></div>	
								<div class='f-left rounded2 third-color mr1 mb1' style='height: 50px; width: 50px;'></div>	
								<div class='f-left circle-edge third-color mr1 mb1' style='height: 50px; width: 110px;'></div>	
								<div class='f-left circle third-color mr1 mb1' style='height: 50px; width: 50px;'></div>			    	
						    </div>
						    <!--CODE-->
					    	<div class="mb3">
