	...
	<aside class="panel-nav--panel dark-color">
		<nav>
			<ul class="reset-list uppercase box">
			    ...
			    <li><a href="font.php">Font and Form</a></li>
			</ul>
		</nav>
	</aside>
    <div class="container-wrapper">
    	<div class="f-height scroll">
		    <header class="bar">
				<div class="table f-height f-width">
				    <div class="t-cell f-height f-width vertical-middle">
				    	<a class="panel-nav--btn inline vertical-middle ml1" href="#">
		    				<h1 class="h3-like mt0 mb0 uppercase text-default">☰ <span class="ml1 inline">Layout</span></h1>
		    			</a>
		    		</div>
		    	</div>
		    </header>
		    	...
		    	<div class="row">
					<div class="s-push1 s-column10 m-push2 m-column8">
					    <section id="grid">
						    ...
						    <p class="sub-text">Cssparrow grid system is fully flexible and responsive. You can manage position and column size to feet on each device. Mix "row" context and "t-row" context to create any layout. Vertical alignement is now easy to implement.</p>
						    <h3><strong>Regular grid</strong></h3>
						    <p class="mb2">use <code class="text-main">.row</code> to create context for <code class="text-main">.colmun(+ column number)</code>. Also use <code class="text-main">s-</code> (tablette screen) and <code class="text-main">m-</code> (desktop screen) prefix to set column behavior for other screen size and device.</p>
						    <div class="row my-grid">
								<div class="column2 mb1"><span class="block bar second-color text-center">2</span></div>
								<div class="column2 mb1"><span class="block bar second-color text-center">2</span></div>
								<div class="column2 mb1"><span class="block bar second-color text-center">2</span></div>
								<div class="column2 mb1"><span class="block bar second-color text-center">2</span></div>
								<div class="column2 mb1"><span class="block bar second-color text-center">2</span></div>
						    ...
						    <div class="row my-grid">        
								<div class="column3 mb1"><span class="block bar second-color text-center">3</span></div>
								<div class="column3 mb1"><span class="block bar second-color text-center">3</span></div>
								<div class="column3 mb1"><span class="block bar second-color text-center">3</span></div>
								<div class="column3 mb1"><span class="block bar second-color text-center">3</span></div>
						    </div>
						    <div class="row my-grid">
								<div class="column4 mb1"><span class="block bar second-color text-center">4</span></div>
								<div class="column4 mb1"><span class="block bar second-color text-center">4</span></div>
								<div class="column4 mb1"><span class="block bar second-color text-center">4</span></div>
						    </div>
						    <div class="row my-grid">
								<div class="column6 mb1"><span class="block bar second-color text-center">6</span></div>
								<div class="column6 mb1"><span class="block bar second-color text-center">6</span></div>
						    </div>
						    <!--CODE-->
					    	<div class="mb3">
						    ...
						    <div class="row">        
								<div class="column12"><span class="block bar second-color text-center mb1">12</span>
								    <div class="row">
										<div class="column6"><span class="block bar second-color text-center mb1">6</span>
										    <div class="row">
												<div class="column6"><span class="block bar second-color text-center mb1">6</span></div>
												<div class="column6"><span class="block bar second-color text-center mb1">6</span></div>
										    </div>
										</div>
										<div class="column6"><span class="block bar second-color text-center mb1">6</span>
							...
							<div class="mix-grid t-row mb1"> 
								<div class="block"><span class="block bar second-color text-center">block</span></div>
								<div class="block"><span class="block bar second-color text-center">block</span></div>
								<div class="block"><span class="block bar second-color text-center">block</span></div>
								<div class="column4 vertical-middle"><span class="block second-color text-center">4</span></div>
								<div class="column4 vertical-middle"><span class="block second-color text-center">4</span></div>
							</div>
							<!--CODE-->
					    	<div class="mb3">
					    ...
					    <section id="margin">
						    ...
						    <p class="mb2">Use <code class="text-main">s-</code> and <code class="text-main">m-</code> prefix like column system to set margin behavior.</p>
						    <div class="row mb2">
						    	<div class="column2">
					    ...
					    <section id="vertical-centerize">
							...
							<div class="centerize-element--height">
							    <div class="table f-height f-width">
									<div class="t-cell f-height f-width vertical-middle text-center">
										<!-- element to centerize -->
										<div class='box main-color inline centerize'>
					    ...
					    <section id="misc">
						    ...
						    <h3><strong>Inline and align</strong></h3>	
						    <p>Use <code class="text-main">.vertical-(top ; bottom ; middle)</code> to play with align.</p>
						    <div class="mb2">
							    <div class="big--block inline vertical-middle box dark-color">big inline element</div>
							    <div class="inline box main-color">inline element</div>
							</div>
							<!--CODE-->				
					    	<div class="mb3">
